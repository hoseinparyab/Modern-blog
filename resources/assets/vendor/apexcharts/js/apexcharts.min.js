	...
	var A = {
		...
		C = function() {
			...
			return a(t, [{
				...
				value: function(t, e) {
					...
					var M = P.bbox();
					if (s) {
						var z = this.graphics.drawRect(M.x - v, M.y - C, M.width + v + w, M.height + A + C, f, d || "transparent", 1, g, p, u);
				...
				value: function(t, e, i, a, s, r, o) {
					...
					if (l.globals.dataChanged && "circle" === m.shape)
						if (this.dynamicAnim) {
							...
							for (var M = 0; M < l.globals.collapsedSeries.length; M++) l.globals.collapsedSeries[M].index === s && (T = 1, a = 0);
				...
				value: function(t, e) {
					...
					for (var n = 0, l = 0; n < t.length; n++, l++) {
						...
						for (var C = a.group({
							...
							I && L.add(I), p = M.y, u = M.x, P > 0 && m.push(u + A / 2), x.push(p);
		...
		Y = function() {
			...
			return a(t, [{
				...
				value: function(t) {
					return Date.parse(t.replace(/-/g, "../index.html").replace(/[a-z]+/gi, " "))
				}
			}, {
				key: "formatDate",
				value: function(t, e) {
		...
		V = function() {
			...
			return a(t, [{
				...
				value: function(t) {
					...
					var e = 0,
						i = t.replace(/xmlns="dashboard.html\/\/www.w3.org\/2000\/svg"/g, (function(t) {
			...
			return a(t, [{
				...
				value: function(t) {
					...
					for (var m = function(t, r) {
						...
						}, v = 0, y = c.globals.series.length - 1; v < c.globals.series.length; v++, y--) m(v, y)
				}
			}, {
				key: "getFormatters",
				value: function(t) {
	...
	var Tt, Mt, zt = function() {
		...
		Xt = function() {
			...
			return a(t, [{
				...
				value: function(t) {
					for (var e = t.currentMillisecond, i = t.currentSecond, a = t.currentMinute, s = t.currentHour, r = t.currentDate, o = t.currentMonth, n = t.currentYear, l = t.minutesWidthOnXAxis, h = t.secondsWidthOnXAxis, c = t.numberOfMinutes, d = a + 1, g = r, u = o, p = n, x = s, b = (60 - i - e / 1e3) * h, m = 0; m < c; m++) d >= 60 && (d = 0, 24 === (x += 1) && (x = 0)), this.timeScaleArray.push({
						position: b,
						value: d,
						unit: "minute",
						hour: x,
				...
				value: function(t) {
					for (var e = t.currentMillisecond, i = t.currentSecond, a = t.currentMinute, s = t.currentHour, r = t.currentDate, o = t.currentMonth, n = t.currentYear, l = t.secondsWidthOnXAxis, h = t.numberOfSeconds, c = i + 1, d = a, g = r, u = o, p = n, x = s, b = (1e3 - e) / 1e3 * l, m = 0; m < h; m++) c >= 60 && (c = 0, ++d >= 60 && (d = 0, 24 === ++x && (x = 0))), this.timeScaleArray.push({
						position: b,
						value: c,
						unit: "second",
						hour: x,
		...
		function() {
			...
			function a(t) {
				...
				switch (t[0]) {
					...
					case "A":
						t = (e = function(t, e) {
							var i, a, s, r, o, n, l, h, c, d, g, u, f, p, x, b, m, v, y, w, k, A, S, C, L, P, T = Math.abs(e[1]),
								M = Math.abs(e[2]),
								z = e[3] % 360,
								I = e[4],
								X = e[5],
							...
							for (b[0][0] = b[0][1].clone(), b[b.length - 1][2] = b[b.length - 1][1].clone(), s = (new SVG.Matrix).rotate(z).scale(T, M).rotate(-z), k = 0, A = b.length; k < A; k++) b[k][0] = b[k][0].transform(s), b[k][1] = b[k][1].transform(s), b[k][2] = b[k][2].transform(s);
